...
using Szlakomat.Products.Infrastructure.Seed.Wieliczka;
...
internal static class KrakowSeedData
{
        ...
        ProductRelationshipFactory relationshipFactory)
    {
        ...
        WieliczkaSaltMineSeed.Seed(productRepo, packageRepo, catalogRepo, relationshipRepo, relationshipFactory);
    }
}
